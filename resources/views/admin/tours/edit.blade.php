        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    {!! Form::open(['url' => 'tour/' . $tour->id, 'method' => 'PUT', 'class' => 'form-horizontal form-label-left', 'novalidate' => '']) !!}
                        <div class="field item form-group">
                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="type_id">
                                Tour type <span class="required">*</span>
                            </label>
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <select class="required form-control col-md-8 col-xs-12" name="type_id" id="type" >
                        ...
                        <div class="field item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <input id="name" class="form-control col-md-8 col-xs-12" name="name" value="{{ $tour->name }}" required="required" type="text">
                            </div>
                            <div class="alert">Please select an option</div>
                        </div>
                        <div class="field item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <input id="interval" class="form-control col-md-8 col-xs-12" name="interval" value="{{ $tour->interval }}" required="required" type="text">
                            </div>
                        ...
                        <div class="field item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <input id="datepicker" name="startDate" required="required" class="form-control col-md-8 col-xs-12" type="text" value="{{ $tour->startDate }}">
                            </div>
                            <div class="alert">please put something here</div>
                        </div>
                        <div class="field item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <input id="datepicker1" name="endDate" required="required" class="form-control col-md-8 col-xs-12" type="text" value="{{ $tour->endDate }}">
                            </div>
                            <div class="alert">please put something here</div>
                        </div>
                        <div class="field item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <input id="price" class="form-control col-md-8 col-xs-12" name="price" required="required" type="text" value="{{ $tour->price }}">
                            </div>
                            <div class="alert">please put something here</div>
                        </div>
                        <div class="field item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <input id="description" class="form-control col-md-8 col-xs-12" name="description" value="{{ $tour->description }}" required="required" type="text">
                            </div>
                            <div class="alert">please put something here</div>
                        </div>
                        <div class="field item form-group">
                        ...
                        <div class="field item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <select class="required form-control col-md-8 col-xs-12" name="blog_id" id="blog">
                                    <option value="">Choose option</option>
                        ...
                        <div class="field item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <select class="required form-control col-md-8 col-xs-12" name="isDiscount" id="discount">
                                    <option value="">Choose option</option>
                        ...
                        <div class="field item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <input id="discountValue" class="form-control col-md-8 col-xs-12" name="discountValue" value="{{ $tour->isDiscount }}" type="text">
                            </div>
                            <div class="alert">Please select an option</div>
                        </div>
