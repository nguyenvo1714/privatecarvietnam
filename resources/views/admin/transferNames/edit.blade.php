        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    {!! Form::open(['url' => '/transferName/'.$transferName->id, 'method' => 'POST', 'class' => 'form-horizontal form-label-left', 'novalidate' => '', 'files' => true]) !!}
                        {{ method_field('PUT') }}
                        <div class="field item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <input id="name" class="form-control col-md-8 col-xs-12" name="name" value="{{ $transferName->name }}" required="required" type="text">
                            </div>
                        ...
                        <div class="field item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <textarea id="description" class="form-control col-md-7 col-xs-12" name="description" required="required" type="text" rows=4>{{ $transferName->description }}</textarea>
                            </div>
                            <div class="alert">please put something here</div>
                        </div>
