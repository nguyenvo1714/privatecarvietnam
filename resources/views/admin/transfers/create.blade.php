        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    {!! Form::open(['url' => 'transfer', 'method' => 'POST', 'class' => 'form-horizontal form-label-left', 'novalidate' => '', 'files' => true]) !!}
                        <div class="field item form-group">
                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="type_id">
                                Type transfer <span class="required">*</span>
                            </label>
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                <select class="required form-control col-md-7 col-xs-12" name="type_id" >
                        ...
                        <div class="field item form-group">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                <select class="required form-control col-md-7 col-xs-12" name="transferName_id" >
                                    <option value="">Choose option</option>
                        ...
                        <div class="field item form-group">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                <select class="required form-control col-md-7 col-xs-12" name="place_id" >
                                    <option value="">Choose option</option>
                        ...
                        <div class="field item form-group">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                <input id="title" class="form-control col-md-7 col-xs-12" name="title" placeholder="Tour mien trung..." required="required" type="text">
                            </div>
                        ...
                        <div class="field item form-group">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                <input id="duration" class="form-control col-md-7 col-xs-12" name="duration" placeholder="2hour 30 minutes" required="required" type="text">
                            </div>
                            <div class="alert">please put something here</div>
                        </div>
                        <div class="field item form-group">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                <input id="description" class="form-control col-md-7 col-xs-12" name="description" placeholder="Tour mien trung..." required="required" type="text">
                            </div>
                            <div class="alert">please put something here</div>
                        </div>
                        <div class="field item form-group">
