    ...
    <section class="content">
        <div class="row">
            <div class="col-lg-12 col-xs-12">
                <div class="title-top">
                    <a class="action-title">Edit Transfer</a>
                    ...
                    <div class="field item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                            <div class="edit-border">
                                <span>
                                    {{ Html::image('/storage/'. $transfer->image_thumb, 'image_thumb', ['class' => 'transfer_thumb']) }}
                                    <div class="post-thumb">
                                        <div class="inner-post-thumb">
                                            <a href="javascript:void(0);" data-id="{{ $transfer->image_thumb }}" class='remove-image'><i class="fa fa-times" aria-hidden="true"></i></a>
                                            <div></div>
                                        </div>
                                    </div>
                                    <input type="file" name="image_thumb" class="image_thumb">
                                </span>
                            </div>
