					...
					@foreach($transfers as $transfer)
				        <div class="col-md-4 col-sm-4 col-xs-12 transfer-list">
				            <div class="private-thumbnail">
				            	...
				            	<div class="position">
				            		<div class="label-detail"><a href="{{ url('/private-transfer/' . $name . '/detail/' . $transfer->title . '/' . $transfer->id) }}">Learn more</a></div>
				            	</div>
				            </div>
				            <h5>
								<a href="{{ url('/private-transfer/' . $name . '/detail/' . $transfer->title . '/' . $transfer->id) }}">{{ $transfer->title }}</a>
				            </h5>
